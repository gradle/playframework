 ...
 */
abstract class AbstractMultiTestRunner extends Runner implements Filterable {
    ...
    protected static abstract class Execution implements Filterable {
        ...
        private static class CannotExecuteRunner extends Runner {
            ...
            CannotExecuteRunner(String displayName, Class<?> testClass, Throwable failure) {
        ...
        private class NestedRunListener extends RunListener {
            ...
            NestedRunListener(RunNotifier notifier) {
