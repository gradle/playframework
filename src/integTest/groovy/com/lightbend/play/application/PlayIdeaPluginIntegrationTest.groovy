...
import com.lightbend.play.fixtures.ide.IdeaModuleFixture
import org.gradle.testkit.runner.BuildResult
import org.gradle.testkit.runner.TaskOutcome
import spock.lang.Ignore

import static com.lightbend.play.fixtures.ide.IdeaFixtures.parseIml
import static com.lightbend.play.fixtures.ide.IdeaFixtures.parseIpr
...
abstract class PlayIdeaPluginIntegrationTest extends PlayIdePluginIntegrationTest {
    ...
    def "IDEA metadata contains correct Scala version"() {
        ...
        buildFile << """
    allprojects {
        pluginManager.withPlugin("com.lightbend.play") {
            tasks.idea {
                doLast {
