...
`runPlay` — {uri-ghpages}/com.playframework.gradle.tasks.PlayRun.html[PlayRun]::
...
`compilePlayTwirlTemplates` — link:{uri-ghpages}/com.playframework.gradle.tasks.TwirlCompile.html[TwirlCompile]::
...
`compilePlayRoutes` — link:{uri-ghpages}/com.playframework.gradle.tasks.RoutesCompile.html[RoutesCompile]::
_Depends on_: Play Route files
+
Compiles routes files into Scala sources.

`minifyPlayJavaScript` — link:{uri-ghpages}/com.playframework.gradle.tasks.JavaScriptMinify.html[JavaScriptMinify]::
