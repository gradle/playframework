...
`runPlay` — {uri-ghpages}/org.gradle.playframework.tasks.PlayRun.html[PlayRun]::
...
`compilePlayTwirlTemplates` — link:{uri-ghpages}/org.gradle.playframework.tasks.TwirlCompile.html[TwirlCompile]::
...
`compilePlayRoutes` — link:{uri-ghpages}/org.gradle.playframework.tasks.RoutesCompile.html[RoutesCompile]::
_Depends on_: Play Route files
+
Compiles routes files into Scala sources.

`minifyPlayJavaScript` — link:{uri-ghpages}/org.gradle.playframework.tasks.JavaScriptMinify.html[JavaScriptMinify]::
