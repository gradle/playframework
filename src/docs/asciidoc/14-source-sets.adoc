...
| routes
| link:{uri-ghpages}/org.gradle.playframework.sourcesets.RoutesSourceSet.html[RoutesSourceSet]
| conf
| routes, *.routes

| twirl
| link:{uri-ghpages}/org.gradle.playframework.sourcesets.TwirlSourceSet.html[TwirlSourceSet]
| app
| \**/*.scala.*

| javaScript
| link:{uri-ghpages}/org.gradle.playframework.sourcesets.JavaScriptSourceSet.html[JavaScriptSourceSet]
| app/assets
| \**/*.js
|===
