...
| routes
| link:{uri-ghpages}/com.playframework.gradle.sourcesets.RoutesSourceSet.html[RoutesSourceSet]
| conf
| routes, *.routes

| twirl
| link:{uri-ghpages}/com.playframework.gradle.sourcesets.TwirlSourceSet.html[TwirlSourceSet]
| app
| \**/*.scala.*

| javaScript
| link:{uri-ghpages}/com.playframework.gradle.sourcesets.JavaScriptSourceSet.html[JavaScriptSourceSet]
| app/assets
| \**/*.js
|===
